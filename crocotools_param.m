...
lonmax = -20;   % Maximum longitude [degree east]
latmin = -60;   % Minimum latitude  [degree north]
...
Roa=0;
%
interp_method = 'linear'; % Interpolation method: 'linear' or 'spline'
%
...
%
CROCOTOOLS_dir = '/home/sgl/CROCO/SWA/croco_tools/';
%
%  Run directory
%
RUN_dir='/home/sgl/CROCO/SWA/Run/';
%
...
%
DATADIR='/home/sgl/CROCO/DATASETS_CROCOTOOLS/'; 
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Yorig         = 1990;          % reference time for vector time
                               % in croco initial and forcing files
%
Ymin          = 1993;          % first forcing year
Ymax          = 2020;          % last  forcing year
...
%--------------------------------------------------
%
CMIP5_dir= [FORC_DATA_DIR,'CMIP5_',CROCO_config,'/'];   % CMIP5 data dir. [croco format]
My_CMIP5_dir=[FORC_DATA_DIR,'CMIP5/'];                  % CMIP5 native data downloaded
                                                        % with python script
itolap_cmip5 = 2;
%
%--------------------------------------------
